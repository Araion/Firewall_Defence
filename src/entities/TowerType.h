...
struct TowerMeta {
    ...
    int cpuCost;               // koszt CPU
    sf::Color color;           // kolor motywu wiezy
};

inline const TowerMeta& towerMeta(TowerType t) {
    static const TowerMeta metas[] = {
        {"Antivirus",    "ANTIVIRUS", "antivirusTowerCost",   100,  8, sf::Color(57, 255, 136)},
        {"Firewall",     "FIREWALL",  "firewallTowerCost",    120,  6, sf::Color(64, 156, 255)},
        {"Laser",        "LASER",     "laserTowerCost",        150, 15, sf::Color(255, 46, 147)},
        {"Data Cleaner", "CLEANER",   "dataCleanerTowerCost", 130, 12, sf::Color(0, 229, 255)},
        {"Overclock",    "OVERCLOCK", "overclockTowerCost",   180, 20, sf::Color(255, 176, 32)},
        {"Corruption",   "CORRUPT",   "corruptionTowerCost",  140, 10, sf::Color(170, 255, 60)},
        {"EMP Burst",    "EMP",       "empTowerCost",          200, 16, sf::Color(160, 110, 255)},
    };
